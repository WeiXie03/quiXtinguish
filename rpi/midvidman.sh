...
raspivid -n -t 0 -b 2600000 -fps 16 -w 640 -h 480 -cd MJPEG -ag 1.0 -ifx none -co 0 -br 40 -awb off -awbg 1.2,1.2 -sa -10 -st -o - | gst-launch-1.0 fdsrc ! jpegparse ! rtpjpegpay pt=96 ! udpsink host=$HOST port=$RPORT &

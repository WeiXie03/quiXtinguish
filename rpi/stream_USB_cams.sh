...
#raspivid -n -t 0 -b 2500000 -rot 270 -fps 20 -w 640 -h 480 -o - | gst-launch-1.0 -v fdsrc ! h264parse ! rtph264pay pt=96 config-interval=5 ! udpsink host=$HOST port=$PICAM_PORT

...
gst-launch-1.0 -v udpsrc port=5000 ! application/x-rtp, media=video, encoding-name=JPEG ! rtpjpegdepay ! jpegdec ! xvimagesink sync=0 &
#receive both in camera streams in parrallel, use clockspeed= to manually set hard framerate(not frames/sec)
